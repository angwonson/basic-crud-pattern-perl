...
$_->get_ok("http://localhost/", "Check redirect of base URL") for $ua1, $ua2, $ua3;
...
$_->get_ok("http://localhost/logout", "Logout via first link on page") for $ua1, $ua2;
...
$ua1->content_contains("/tickets/create_form\">Admin Create Ticket</a>",
    "'test01' should have a create link");
$ua2->content_lacks("/tickets/create_form\">Admin Create</a>",
...
# User 'test03' should not be able to add a ticket
$ua3->get_ok("http://localhost/tickets/url_create/TestTitle2/2/5", "'test03' add");
$ua3->content_contains("Unauthorized!", "Check 'test03' cannot add");
